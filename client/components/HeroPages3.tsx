...
function HeroPages3() {
  return (
    <div
      className={`relative min-h-screen w-full bg-[url(/assets/it-ChooseUs/woman-holding-clipboard-her-coworkers.jpg)] bg-cover bg-no-repeat`}
    >
