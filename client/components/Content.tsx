...
const Content = () => {
  return (
    <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 pt-16 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10">
      ...
      <div className="-ml-12 -mt-12 p-12 lg:sticky lg:top-4 lg:col-start-2 lg:row-span-2 lg:row-start-1 lg:overflow-hidden">
        <Image
          className="w-[48rem] max-w-none rounded-xl bg-gray-900 shadow-xl ring-1 ring-gray-400/10 sm:w-[57rem] object-cover object-left"
          src="/assets/it-ChooseUs/corporate-management-strategy-solution-branding-concept.webp"
          alt="workWithUS"
          width={2000}
          height={2000}
        />
